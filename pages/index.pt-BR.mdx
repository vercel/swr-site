...
SWR é criado pelo mesmo time por trás do [Next.js](https://nextjs.org), o framework React. Siga [@vercel](https://x.com/vercel) no X para atualizações futuras do projeto.
