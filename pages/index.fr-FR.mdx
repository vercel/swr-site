...
<div className="mt-16 mb-20 text-center">
  [Démarrage](/docs/getting-started) · [Exemples](/examples/basic) · [Blog](/blog) · [Dépôt GitHub](https://github.com/vercel/swr)
</div>
...
Dans cet exemple, le hook `useSWR` accept un string `key` et une fonction `fetcher`. `key` est un identifiant unique de la donnée (normalement l'URL de l'API)
