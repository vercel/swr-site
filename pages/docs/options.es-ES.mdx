...
More information can be found [here](/docs/advanced/return-values).
...
- `keepPreviousData = false`: return the previous key's data until the new data has been loaded [(detalles)](/docs/advanced/return-values#return-previous-data-for-better-ux)
