...
- `fallback`: a map of multiple fallback data to be returned [(details)](/docs/with-nextjs)
- `fallbackData`: datos iniciales a devolver (nota: Esto es por un hook) [(detalles)](/docs/with-nextjs)
