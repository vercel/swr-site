...
SWR lhe dará a opção de reobter automaticamente. É **inteligente**, o que significa que a re-obtenção só ocorrerá se o componente associado ao hook estiver **visível em tela**.
