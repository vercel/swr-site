...
The information of return values can be found [here](/docs/return-values).
...
- `keepPreviousData = false`: return the previous key's data until the new data has been loaded
