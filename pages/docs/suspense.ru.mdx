...
<Callout emoji="🚨" type="error">
  Задержка (Suspense) в настоящее время является <strong>экспериментальной</strong> функцией React. Эти API могут значительно измениться без предупреждения, прежде чем станут частью React.<br/>
  <a href="https://ru.reactjs.org/docs/concurrent-mode-suspense.html" target="_blank" rel="noopener">Подробнее</a>
</Callout>
