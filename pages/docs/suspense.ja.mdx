...
<Callout emoji="🚨" type="error">
  React はまだサスペンスをデータ取得フレームワークである SWR などで使うことを <strong>推奨していません</strong> (<a href="https://reactjs.org/blog/2022/03/29/react-v18.html#suspense-in-data-frameworks" target="_blank" rel="noopener">詳細</a>)。 この API は将来的に私たちの調査により変更される可能性があります。
</Callout>
