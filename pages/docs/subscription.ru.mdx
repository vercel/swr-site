...
- `subscribe`: Функция, которая подписывается на реальный источник данных. Онп принемает ключ и объект со следующими свойствами:


Аргументы `subscribe`
- `next`: Функция, которая принимает ошибку и данные и обновляет состояние последними полученными данными от реального источника данных.

`subscribe` возвращает функцию, которая отписывается от реального источника данных.
