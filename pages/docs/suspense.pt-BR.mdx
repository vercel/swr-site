...
<Callout emoji="🚨" type="error">
  React still <strong>doesn't recommend</strong> using Suspense in data frameworks like SWR (<a href="https://reactjs.org/blog/2022/03/29/react-v18.html#suspense-in-data-frameworks" target="_blank" rel="noopener">More information</a>). This API may change in the future as the result of our research.
</Callout>
...
=======
>>>>>>> 468d645 (docs: add notes for Suspense on SSR and React v18)
---
...
### Note: With Server-side Rendering
