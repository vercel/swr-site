...
<Callout emoji="🚨" type="error">
  O React <strong>não recoomenda</strong> usar `Suspense` em frameworks de dados como o SWR (<a href="https://reactjs.org/blog/2022/03/29/react-v18.html#suspense-in-data-frameworks" target="_blank" rel="noopener">Mais informações</a>). Essas APIs podem mudar no futuro como resultados da nossa pesquisa.
</Callout>
