...
Cela signifie que lorsque l'ordinateur de l'utilisateur se réveille ou qu'il passe d'un onglet à l'autre, les données seront automatiquement actualisées.
