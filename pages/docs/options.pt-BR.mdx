...
- `keepPreviousData = false`: return the previous key's data until the new data has been loaded [(detalhes)](/docs/advanced/understanding-swr#return-previous-data-for-better-ux)
