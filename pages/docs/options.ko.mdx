...
- `keepPreviousData = false`: return the previous key's data until the new data has been loaded [(상세내용)](/docs/advanced/return-values#return-previous-data-for-better-ux)
