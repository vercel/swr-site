...
- `keepPreviousData = false`: return the previous key's data until the new data has been loaded [(details)](/docs/advanced/understanding-swr#return-previous-data-for-better-ux)
