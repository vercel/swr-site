...
Almost 2 years ago we [open sourced](https://x.com/vercel/status/1188911002626097157) SWR, the tiny data-fetching React library that people love. Today we are reaching another milestone: the 1.0 version of SWR!
...
Special thanks to [Toru Kobayashi](https://x.com/koba04) and [Yixuan Xu](https://x.com/yixuanxu94) for their contributions to the library, and [Paco Coursey](https://x.com/pacocoursey), [uttk](https://github.com/uttk), [Tomohiro SHIOYA](https://github.com/shioyang), [Markoz Peña](https://github.com/markozxuu), [SeulGi Choi](https://github.com/cs09g), [Fang Lu](https://github.com/huzhengen), [Valentin Politov](https://github.com/valentinpolitov) for their work on the translations and docs. This release can't happen without them.
