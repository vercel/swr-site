---
image:
description: 'We are excited to introduce SWR v2.0, including features to improve the use experience of your application.'
date:
---
...
### Mutate accepts a filter function
...
### The Cache interface requires a `keys()`
