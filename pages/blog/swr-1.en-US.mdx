...
useSWRImmutable(key, value, options)
```
...
A lot of new ideas can be implemented based on this feature, and we've built 2 examples: _Request Logger_ and _Keep Previous Result_. Check the [Middleware API](/docs/middleware) for more details.

### Improvements and More Tests

Since 0.x, we've made tons of small improvements and bugfixes. SWR now has 153 tests that cover most of the edge cases that might happen in data fetching. Check the [Changelog](https://github.com/vercel/swr/releases) for more details.

### Docs Translations

Thanks to our contributors, the SWR documentation site now has translations of 5 different languages:
