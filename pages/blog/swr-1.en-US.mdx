...
Middleware for SWR is a new way for you to build and share abstractions on top of SWR hooks:
...
A lot of new ideas can be implemented based on this feature, and we've built 2 examples: [_Request Logger_](/docs/middleware#request-logger) and [_Keep Previous Data When Changing the Key_](/docs/middleware#keep-previous-result).
