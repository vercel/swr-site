...
When building a web app, you might need to reuse the data in many places of the UI. It is incredibly to create reusable data hooks
on top of SWR:
...
The code is much more simpler and easier to maintain now. 
