...
export const languageMap: LocalesMap = {
  "en-US": "English",
  "es-ES": "Español",
...
export const titleMap: LocalesMap = {
...
export type FeatureKey =
  ...
  | "typescript"
  | "remoteLocal";
export const featuresMap: LocalesMap<Record<FeatureKey, string>> = {
  "en-US": {
...
export const headDescriptionMap: LocalesMap = {
  "en-US":
...
export const feedbackLinkMap: LocalesMap = {
...
export const editTextMap: LocalesMap = {
...
export const footerTextMap: LocalesMap<{
  utmSource: string;
  text: string;
...
export const tableOfContentsTitleMap: LocalesMap = {
  "en-US": "On This Page",
...
export const searchPlaceholderMap: LocalesMap = {
...
export const gitTimestampMap: LocalesMap = {
